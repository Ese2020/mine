...
export const History = () => {
    ...
    return (
        <div className="hist-container">
            ...
            <div className="hist-sec2">
                <div className="monarch-title">
                    <h1>History</h1>
                </div>
                <div className="mon-hist">
                    ...
                    <div>
                        ...
                        <p>He finally arrived in Lagos, where he first met his friend, Akitoye, the then Oba of Lagos. After discussing with his friend, he turned himself into the British in Lagos, which was already a British Colony at the time.</p>
                    </div>
                    <div>
